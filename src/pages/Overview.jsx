  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="mb-4 md:mb-6">
        <h1 className="text-xl md:text-2xl font-bold text-txt-1">Overview</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
        {[
          ...
          <div key={i} className="bg-panel border border-line-soft rounded-xl p-3">
            ...
            <div className={`font-mono text-lg md:text-2xl font-semibold mt-2 ${m.amber ? 'text-amber' : 'text-txt-1'}`}>{m.v}</div>
            <div className={`font-mono text-xs mt-1 ${m.up ? 'text-up' : 'text-down'}`}>{m.up ? '▲' : '▼'} {m.c}</div>
          </div>
        ))}
      </div>

      {/* Watchlist */}
      <div className="bg-panel border border-line-soft rounded-xl p-4 mb-3">
            ...
            <div key={i} className="flex items-center justify-between p-2.5 bg-panel-2 rounded-lg border border-line-soft">
              <div className="flex items-center gap-2.5 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-sm font-medium text-txt-1 truncate">{s.name}</div>
